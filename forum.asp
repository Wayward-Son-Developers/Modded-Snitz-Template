...
Response.Write	"<table class=""misc"">" & vbNewLine & _
				"<tr>" & vbNewLine & _
				"<td class=""secondnav"" width=""40%"">" & vbNewLine & _
				"<a href=""default.asp"">" & getCurrentIcon(strIconFolderOpen,"All Forums","align=""absmiddle""") & "</a>&nbsp;<a href=""default.asp"">" & strForumTitle & "</a><br />" & vbNewLine & _
				getCurrentIcon(strIconBlank,"","align=""absmiddle""")
...
Response.Write	"&nbsp;<a href=""default.asp?CAT_ID=" & Cat_ID & """>" & ChkString(Cat_Name,"display") & "</a><br />" & vbNewLine & _
				getCurrentIcon(strIconBlank,"","align=""absmiddle""") & getCurrentIcon(strIconBlank,"","align=""absmiddle""")
...
Response.Write	"&nbsp;<a href=""forum.asp?" & ArchiveLink & "FORUM_ID=" & Forum_ID & """>" & ChkString(Forum_Subject,"display") & "</a></td>" & vbNewLine & _
				"<td class=""secondnav"" align=""center"" valign=""bottom"" width=""20%"">" & vbNewLine
call PostNewTopic()
Response.Write	"</td>" & vbNewLine & _
				"<td class=""secondnav"" align=""right"" valign=""bottom"" width=""40%"">" & vbNewLine & _
...
if iTopicCount = "" then
	Response.Write	"<tr>" & vbNewLine & _
					"<td colspan=""7"">No Topics Found</td>" & vbNewLine & _
					"</tr>" & vbNewLine
else
	tT_STATUS = 0
	tCAT_ID = 1
	...
	for iTopic = 0 to iTopicCount
		...
		Response.Write	"<tr>" & vbNewLine & _
						"<td class=""statusicon""><a href=""topic.asp?" & ArchiveLink & "TOPIC_ID=" & Topic_ID & """>"
		...
		Response.Write	"<div class=""forumlink""><a href=""topic.asp?" & ArchiveLink & "TOPIC_ID=" & Topic_ID & """>" & ChkString(Topic_Subject,"title") & "</a></div>" & vbNewLine
		if strShowPaging = "1" then 
			Call TopicPaging() 
		end if
		Response.Write	"</td>" & vbNewLine & _
						"<td class=""authlink"">" & profileLink(chkString(Topic_MName,"display"),Topic_Author) & "</td>" & vbNewLine & _
		...
		if IsNull(Topic_LastPostAuthor) then
			...
			strLastAuthor = "<br />by:&nbsp;" & profileLink(ChkString(Topic_LastPostAuthorName, "display"),Topic_LastPostAuthor)
			if (strJumpLastPost = "1") then strLastAuthor = strLastAuthor & "&nbsp;" & DoLastPostLink
		end if
		Response.Write	"<td class=""counts""><span class=""lastpost"">" & ChkDate(Topic_LastPost,"&nbsp;",true) & _
...
' TOPIC SORTING MOD
'-------------------------------------------------
Response.Write	"<tr class=""header smtext"">" & vbNewLine & _
				"<td colspan=""6"">" & vbNewLine
...
Response.Write	", sorted by&nbsp;<select name=""sortfield"" style=""font-size:10px;"">" & vbNewLine & _
				...
				"</select>&nbsp;in&nbsp;<select name=""sortorder"" style=""font-size:10px;"">" & vbNewLine & _
				...
				"</select>&nbsp;order, from&nbsp;<select name=""Days"" style=""font-size:10px;"">" & vbNewLine & _
				...
				"</select>" & vbNewLine & _
				"<input type=""hidden"" name=""Cookie"" value=""1""><button type=""submit"" name=""Go"">Go</button>" & vbNewLine & _
				"</form>" & vbNewLine & _
				"</td>" & vbNewLine
if mLev > 0 or (lcase(strNoCookies) = "1") then
...
Response.Write	"<table class=""misc2"">" & vbNewLine & _
				"<tr>" & vbNewLine & _
				"<td align=""left"" valign=""top"" width=""40%"">" & vbNewLine & _
...
' DEM --> End of Code added for moderation
Response.Write	"</td>" & vbNewLine & _
				"<td align=""center"" valign=""top"" width=""20%"">" & vbNewLine
call PostNewTopic()
Response.Write	"</td>" & vbNewLine & _
				"<td align=""right"" valign=""top"" width=""40%"" nowrap>" & vbNewLine
%>
...
sub DropDownPaging(fnum)
	if maxpages > 1 then
		...
		If ShowMinPage then
			Response.Write	" <a href=""forum.asp?whichpage=1&FORUM_ID=" & Forum_ID & "&sortfield=" & strtopicsortfld & _
							"&sortorder=" & strtopicsortord & _
							"""><< First</a> "
		End If
		For counter = MinPageToShow To MaxPageToShow
			if counter <> cLng(pge) then   
				Response.Write	" <a href=""forum.asp?whichpage=" & counter & "&FORUM_ID=" & Forum_ID &"&sortfield=" & _
		...
		Next
		If ShowMaxPage then
			Response.Write	" <a href=""forum.asp?whichpage=" & maxpages & "&FORUM_ID=" & Forum_ID &"&sortfield=" & strtopicsortfld & _
							"&sortorder=" & strtopicsortord & _
							""">>> Last</a> "
		End If
		Response.Write	"]"
