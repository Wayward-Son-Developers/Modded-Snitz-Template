...
if (Moderation = "Y" and Topic_Status > 1 and Topic_Author <> MemberID) then
	Call FailMessage("<li>Viewing of this Topic is not permitted until it has been moderated. Please try again later</li>",True)
	WriteFooter
	Response.end
else
	Response.Write	"<script language=""JavaScript"" type=""text/javascript"">" & vbNewLine & _
	...
	if ArchiveView = "true" then
		Response.Write	getCurrentIcon(strIconBlank,"","align=""absmiddle""") & getCurrentIcon(strIconBlank,"","align=""absmiddle""") & getCurrentIcon(strIconBlank,"","align=""absmiddle""") & getCurrentIcon(strIconFolderArchived,"","align=""absmiddle""") & "&nbsp;"
	elseif Cat_Status <> 0 and Forum_Status <> 0 and Topic_Status <> 0 then
		Response.Write	getCurrentIcon(strIconBlank,"","align=""absmiddle""") & getCurrentIcon(strIconBlank,"","align=""absmiddle""") & getCurrentIcon(strIconBlank,"","align=""absmiddle""") & getCurrentIcon(strIconFolderOpenTopic,"","align=""absmiddle""") & "&nbsp;"
	else
		Response.Write	getCurrentIcon(strIconBlank,"","align=""absmiddle""") & getCurrentIcon(strIconBlank,"","align=""absmiddle""") & getCurrentIcon(strIconBlank,"","align=""absmiddle""") & getCurrentIcon(strIconFolderClosedTopic,"","align=""absmiddle""") & "&nbsp;"
	end if
	...
	if maxpages > 1 then
		Response.Write	"<table class=""admin"" width=""95%"">" & vbNewLine & _
						"<tr>" & vbNewLine & _
						"<td class=""smtext"">"
...
Sub QuickReply()
	If isReadOnly(Forum_ID,MemberID) = 0 Then
